# Thuật Toán Luận Ứng Kỳ (Lục Hào) - Chuẩn Lưu Xương Minh + Dã Hạc

Tài liệu này trình bày thuật toán xác định thời điểm ứng nghiệm (Ứng Kỳ) dựa trên các "Bệnh" của Dụng Thần và quy luật vận động của Hào, được đối soát với giáo trình Lưu Xương Minh và bổ sung từ hệ thống luận quẻ của Dã Hạc.
...
6. **Hóa Quẩn Chân** *(Bổ sung từ Dã Hạc)* (Ứng kỳ bị trễ, chờ ngày Xung khai).
7. **Động/Tĩnh** (Vận động tự thân).
...
| **🔗 Hóa Quẩn Chân** *(Dã Hạc)* | DT hào động hóa ra hào Lục Hợp với chính nó | Ngày **Xung khai hào biến** (phá Quẩn Chân) |
...
- **Nguyệt Mộ ≠ Nhập Mộ (Dã Hạc):** Chỉ Nhật Mộ, Động Mộ, Hóa Mộ mới là Nhập Mộ thật ảnh hưởng đến cát hung và ứng kỳ. Nguyệt Mộ chỉ dùng để mô tả trạng thái sự việc (trì trệ, mơ hồ), không có ứng kỳ riêng.
- **Xung Không thành Thực (Dã Hạc):** Hào đang Tuần Không mà bị Nhật xung → không phải Nhật Phá mà là **Ám Động** đặc biệt — hào trở nên có thực chất ngay.

---
*Tài liệu được đối soát với NotebookLM (Lưu Xương Minh) và bổ sung từ notebook Dã Hạc.*
